-- Compromissos recorrentes semanais (EGO-AI). Execute no SQL Editor se não usar CLI de migrações.
...
comment on table public.agenda is 'Compromissos recorrentes: dias da semana (seg,ter,...) + horário local do utilizador.';
