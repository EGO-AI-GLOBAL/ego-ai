-- ============================================================
-- EGO-AI 1.0.25 — Descarrego da noite + Lista de compras
-- Copie TUDO no Supabase → SQL Editor → Run (idempotente)
-- ============================================================
...
-- Verificação: deve listar as 2 tabelas novas
select table_name
from information_schema.tables
where table_schema = 'public'
  and table_name in ('agenda_drafts', 'shopping_list_items')
order by table_name;
