# Finch vs EGO Monstrinhos — checklist de paridade
...
## Obrigatório para paridade funcional

| # | Área Finch | EGO Monstrinhos | Estado | Notas |
|---|------------|-----------------|--------|-------|
| 1 | Pet virtual que reage ao cuidado | Monstrinhos do humor (5 moods) | ✅ | Luna/Leo separados no chat; jardim tem pet próprio |
| 2 | Check-in de humor diário | 1 toque + streak | ✅ | `record_checkin` |
| 3 | Economia (moeda + recompensas) | Sementes 🌰 | ✅ | missões + check-in |
...
| 20 | Eventos sazonais (micropets, wearables) | — | ❌ | 13+ |
| 21 | Outfit / skins do pet | Cores ovo Bolso | 🟡 | Bolso separado |
| 22 | Som ambiente / soundscapes | — | ❌ | 14+ |
| 23 | Finch Plus / cosméticos premium | Planos EGO (Stripe) | 🟡 | não misturar com Monstrinhos |

---

## Monitoramento Finch (público)

| Data | Versão Finch | O que mudou (texto loja) | Gap novo para EGO? |
|------|--------------|--------------------------|-------------------|
| 2026-06-25 | 3.73.x (Play) | Bugfixes + tweaks visuais | Não — manter estabilidade |
| 2025-08 | 3.73.52 | Evento Poolside Pals (micropet Lumi, wearables) | Sim → linha 20 (eventos sazonais) |

**Próxima revisão automática:** +7 dias — comparar notas App Store/Play e atualizar tabela acima.
...
## Critério de sucesso (utilizador real)
