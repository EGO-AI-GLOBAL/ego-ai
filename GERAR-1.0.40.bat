...
title Gerar 1.0.40 — iOS 26 + Android 75
...
echo   EGO-AI 1.0.40 — Monstrinhos + Companheiro + chat limpo

echo ============================================================

echo.

echo ANTES (manual): DEPLOY-API-1.0.40.bat (git push + Railway)
...
echo [2/2] Android 1.0.40 code 75...
...
echo Proximo: SUBMIT-IOS-1.0.40.bat + PUBLICAR-1.0.40-PLAY.bat
