...
chcp 65001 >nul
cd /d "%~dp0"
title Gerar 1.0.77 — visual + Monstrinhos F10 + PAUSA v2

echo.
echo ============================================================
echo   EGO-AI 1.0.77 — pack completo
echo ============================================================
echo.
...
if errorlevel 1 ( pause & exit /b 1 )
call _ego_run_python.bat scripts\wait_and_submit_eas.py queue --ids-file builds-1.0.77.ids.json
if errorlevel 1 ( pause & exit /b 1 )

echo.
echo Depois: AGUARDAR-E-SUBMETER-1.0.77.bat
pause
