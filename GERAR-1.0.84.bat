...
chcp 65001 >nul
cd /d "%~dp0"
title Gerar 1.0.84 — iOS + Android

echo.
echo ============================================================
echo   EGO-AI 1.0.84 — Tríade Silenciosa PAUSA + Monstrinhos
echo ============================================================
echo   iOS 86 + Android 128 · submit iOS auto · Android manual
echo.
...
echo.
echo Depois: AGUARDAR-E-SUBMETER-1.0.84.bat
pause
