-- AGENDA COMPARTILHADA — execute TODO no Supabase → SQL Editor (uma vez).
-- 1) Tabelas + RLS
-- 2) Função lookup e-mail (convites)

-- === migration 20260529120000_shared_calendars.sql ===
...
-- === migration 20260530120000_lookup_user_by_email.sql ===
